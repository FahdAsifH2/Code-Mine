...
<div className="relative flex items-center justify-center min-h-screen w-full bg-gradient-to-br from-slate-950 via-teal-950 to-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 text-center ">
        <div className="relative">
          ...
          <h1 className="font-mono pt-20 mb-100 font-bold text-8xl md:text-9xl leading-none tracking-tight bg-gradient-to-r from-teal-300 via-cyan-200 to-green-400 bg-clip-text text-transparent filter drop-shadow-2xl" style={{
