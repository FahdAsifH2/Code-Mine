...
import { getFirestore } from "firebase/firestore"; // ← YE LINE ADD KARNI HAI
...
const db = getFirestore(app); // ← YE LINE ADD KARNI HAI

export { app, auth, analytics, db }; // ← SIRF db ADD KARNA HAI EXPORT MEIN